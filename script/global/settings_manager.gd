...
var FILE_PATH: String = get_user_directory() + "settings.cfg"
...
func load_settings() -> Dictionary[String, Dictionary]:
	...
	if error == OK:
		...
		var synced_data = add_missing_settings(loaded_data)
...
func add_missing_settings(loaded_data: Dictionary[String, Dictionary]) -> Dictionary:
...
func clean_settings(settings: Dictionary[String, Dictionary]) -> void:
